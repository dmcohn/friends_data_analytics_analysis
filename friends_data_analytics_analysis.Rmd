...
Similarly, the boxplot of IMDB data by season episode number shows season finales (Episodes 23-25) were the most critically acclaimed
among audiences, while Episodes 19-22 had a slight drop in median ratings; this is consisent with the viewership finding for these episodes, and suggests that a possible explanation for the slight drop in viewership was the fact that those episodes (leading into the finale) were not as well received by audiences.
